...
public class CanvasGraphic2D extends JPanel implements iGraphic, ActionListener {
     ...
     *
     * Gamelogic logic = new Gamelogic(); logic.initTestState();
     *
     * CanvasGraphic2D graphics = new CanvasGraphic2D(logic, 11, 11, "Klaus"); graphics.initialize(); graphics.refresh();
     *
     * }
     */
    /**
     ...
     * @param size_x width of the field
     * @param size_y height of the field
